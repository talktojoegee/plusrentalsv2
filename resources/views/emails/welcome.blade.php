                                ...
                                <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                                    <div class="f-fallback">
                                        ...
                                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;"> We’re thrilled to have you on board. To get the most out of
                                            {{config('app.name')}}, do well to explore the various features available</p>
                                        <p>IMPORTANT: Your 14 day free trial starts today being <strong style="color: #22D172">{{ date('d M, Y', strtotime(now())) }}</strong> and will end on <strong style="color: #ff0000">{{date('d M, Y', strtotime(\Carbon\Carbon::now()->addDays(14)))}}</strong>. Please don't hesitate to contact us if you face any challenge.
                                        Our support unit will be more than happy to help.</p>
                                        <p>Meanwhile, click the button below to access your manager panel - where you'll do most of your activities.</p>
                                            ...
                                            <tr>
                                                <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                                <a href="{{route('manager-login')}}" class="f-fallback button" target="_blank" style="color: #FFF; border-color: #3869d4; border-style: solid; border-width: 10px 18px; background-color: #3869D4; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Access Manager Login</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
