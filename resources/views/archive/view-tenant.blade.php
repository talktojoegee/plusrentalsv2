                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table m-0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><label for="" class="label label-info">{{$tenant->getProperty->getCompany->ownership_type == 1 ? 'Individual' : 'Company/Trust'}}</label> </td>
                                                                    </tr>
                                                                    @if($tenant->getProperty->getCompany->ownership_type == 1)
                                                                        <tr>
                                                                            <th scope="row">Full Name</th>
                                                                            <td>{{$tenant->getProperty->getCompany->title ?? ''}} {{$tenant->getProperty->getCompany->first_name ?? ''}} {{$tenant->getProperty->getRentalOwner->surname ?? ''}}</td>
                                                                        </tr>
                                                                        <tr>
