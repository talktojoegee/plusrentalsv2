...
@section('main-content')
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    <i class="icofont icofont-tools-alt-2  bg-c-blue card1-icon"></i>
                    <span class="text-c-blue f-w-600">Overall</span>
                    <h4>{{number_format($tasks->count())}}</h4>
                    <div>
                        <span class="f-left m-t-10 text-muted">
                            <i class="text-c-blue f-16 ti-calendar m-r-10"></i>From Inception
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    <i class="icofont icofont-tools-alt-2  bg-c-pink card1-icon"></i>
                    <span class="text-c-pink f-w-600">Cancelled</span>
                    <h4>{{number_format($tasks->where('status',3)->count())}}</h4>
                    <div>
                        <span class="f-left m-t-10 text-muted">
                            <i class="text-c-pink f-16 ti-close m-r-10"></i>All Cancelled Tasks
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    <i class="icofont icofont-tools-alt-2  bg-c-green card1-icon"></i>
                    <span class="text-c-green f-w-600">Completed</span>
                    <h4>{{number_format($tasks->where('status',2)->count())}}</h4>
                    <div>
                        <span class="f-left m-t-10 text-muted">
                            <i class="text-c-green f-16 ti-check m-r-10"></i>All Completed Tasks
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    <i class="icofont icofont-tools-alt-2  bg-c-yellow card1-icon"></i>
                    <span class="text-c-yellow f-w-600">Started</span>
                    <h4>{{number_format($tasks->where('status',1)->count())}}</h4>
                    <div>
                        <span class="f-left m-t-10 text-muted">
                            <i class="text-c-yellow f-16 icofont icofont-sand-clock m-r-10"></i>All Tasks Currently In Progress
                        </span>
                    </div>
                </div>
            </div>
