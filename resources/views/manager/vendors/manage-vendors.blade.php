                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xl-12">
                            ...
                            <ul class="nav nav-tabs md-tabs " role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-business-man-alt-1 mr-2"></i> Individual Vendors</a>
                                    <div class="slide"></div>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-sm-12">
                                        ...
                                        <table id="focus-key" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="focus-key_info" style="position: relative;">
                                            ...
                                            <tr role="row" class="text-uppercase">
                                                ...
                                                <th class="sorting" tabindex="0"  aria-label="Rental Owner: activate to sort column ascending" >Vendor</th>
                                            ...
                                            @php
                                                $serial = 1;
                                            @endphp
                                            @foreach($vendors as $rental)
                                                @if($rental->vendor_type == 1)
                                                    <tr>
                                                        <td>{{$serial++}}</td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info btn-mini" href="{{route('view-vendor', $rental->slug)}}"><i class="icofont icofont-eye-alt"></i></a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @endforeach
