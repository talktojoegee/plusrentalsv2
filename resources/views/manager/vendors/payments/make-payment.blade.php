...
@section('title')
    Make Payment | Bill No: {{$bill->bill_no ?? ''}}
@endsection

@section('current-page')
    Make Payment for Bill No.: <span class="text-primary">{{$bill->bill_no ?? ''}}</span>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group float-right mb-3">
                <a href="{{route('manage-invoices')}}" class="btn btn-secondary btn-mini"><i class="icofont icofont-tags"></i>Manage Bills</a>
                <a href="{{route('generate-new-invoice')}}" class="btn btn-primary btn-mini"><i class="icofont icofont-tasks"></i>Generate New Bills</a>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                <div class="invoice-box" id="receiptWrapper">
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr class="total">
                            ...
                            <td></td>
                            <td></td>
                            <td>Balance: {{'₦'.number_format(($bill->total) - ($bill->paid_amount) ,2)}}</td>
                        </tr>
                        <tr class="">
                            <td></td>
                            <td></td>
                            ...
                            <td></td>
                            <td>
                                @if(($bill->total) - ($bill->paid_amount) <= 0)
                    ...
                    <div class="col-lg-12 col-xl-12 d-flex justify-content-center">
                        <div class="card mt-3">
                            <div class="card-block">
                                <div class="btn-group">
                                    <a href="{{route('manage-invoices')}}" class="btn btn-mini btn-warning"><i class="icofont icofont-square-left mr-2"></i> Back</a>
                                    @if(($bill->total) - ($bill->paid_amount) <= 0)
            ...
            <div class="card card-border-primary">
                <div class="card-header">
                    <h5 class="card-header-text text-uppercase">
                        <i class="icofont icofont-ui-note m-r-10"></i> Bill Detail
                    </h5>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-xs">
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{!is_null($bill->created_at) ? date('d M, Y', strtotime($bill->created_at)) : '-'}}</td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        <a href="javascript:void(0);">
                                            {{$bill->getIssuedBy->first_name ?? ''}} {{$bill->getIssuedBy->surname ?? ''}}
                                        </a>
                                    </div>
                                </td>
                            </tr>
