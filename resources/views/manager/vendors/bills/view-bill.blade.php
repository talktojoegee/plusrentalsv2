...
@section('title')
    View Bill | Bill No: {{$bill->bill_no ?? ''}}
@endsection
                    ...
                    <tr class="top">
                        <td colspan="6">
                            <table>
                                <tr>
                                    <td class="title">
                                        <img src="/assets/drive/{{Auth::user()->getUserCompany->logo ?? 'connexxion.png'}} " style="width: 100%; max-width: 300px" />
                                    </td>
                    ...
                    <tr class="information">
                        <td colspan="6">
                            <table>
                                <tr>
                                    <td>
                                        {{Auth::user()->getUserCompany->company_name ?? ''}}<br />
                                        {{Auth::user()->getUserCompany->address_1 ?? ''}}<br />
                                        {{Auth::user()->getUserCompany->mobile_no ?? ''}}, {{Auth::user()->getUserCompany->email ?? ''}}
                                    </td>
                        ...
                        <div class="card-block">
                            <div class="btn-group">
                                ...
                                @if($bill->posted == 1)
                                    ...
                                    <a class="btn btn-secondary btn-mini" href="{{route('send-bill-via-email', $bill->slug)}}"><i class="icofont icofont-ui-email mr-2"></i> Email</a>
                                @endif
            ...
            <div class="card card-border-primary">
                <div class="card-header">
                    <h5 class="card-header-text text-uppercase">
                        <i class="icofont icofont-ui-note m-r-10"></i> Bill Details
                    </h5>
                </div>
