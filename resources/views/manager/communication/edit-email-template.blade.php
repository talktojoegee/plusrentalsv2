        ...
        <div class="col-lg-8  col-xl-8 col-md-8">
            ...
            <div class="card">
                <div class="card-block">
                    <h5 class="sub-title">Edit Email Template</h5>
                    ...
                    @endif
                    <form action="{{route('update-email-template')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="">Template Name</label>
                                    <input type="text" placeholder="Template Name" value="{{old('template_name', $template->template_name)}}" name="template_name" class="form-control">
                                    @error('template_name')
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Subject" value="{{old('subject', $template->subject)}}" name="subject" class="form-control">
                                    @error('subject')
                                        <i class="text-danger mr-2">{{$message}}</i>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="body" id="body" placeholder="Body" class="form-control content">{!!old('body', $template->body)!!}</textarea>
                                    @error('body')
                                        <i class="text-danger mr-2">{{$message}}</i>
                                    @enderror
                                </div>
