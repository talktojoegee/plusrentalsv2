...
@section('title')
    Generate New Invoice for {{$applicant->first_name ?? ''}} {{$applicant->surname ?? ''}}
@endsection

@section('current-page')
    Generate New Invoice for <small class="text-primary">{{$applicant->first_name ?? ''}} {{$applicant->surname ?? ''}}</small>
@endsection
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Generate An Invoice</h5>
                    <p>Use the section below to generate an invoice <strong>{{$applicant->first_name ?? ''}}</strong></p>
                </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                @endif
                                <form action="{{route('lease-generate-invoice-for')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="">Invoice Type</label>
                                                <input type="text" readonly value="New Lease" placeholder="Invoice Type" class="form-control">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly value="{{$applicant->first_name ?? ''}} {{$applicant->surname ?? ''}}" class="form-control">
                                                <input type="hidden" name="applicant" id="applicant" class="form-control " value="{{$applicant->id}}">
                                                @error('tenant')
                                                <i class="text-danger mt-2">{{$message}}</i>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly value="{{$property->property_name ?? ''}}" class="form-control">
                                                <input type="hidden" name="property" id="property" class="form-control" value="{{$property->id}}">
                                                @error('property')
                                                <i class="text-danger mt-2">{{$message}}</i>
                                                @enderror
                                            </div>
