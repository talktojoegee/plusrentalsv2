...
@section('main-content')
    <form action="{{route('add-new-question-answer')}}" method="post" enctype="multipart/form-data">
        <div class="row">
            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="question" placeholder="Question" value="{{old('question')}}" class="form-control">
                                                @error('question')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="answer" id="answer" class="content form-control" placeholder="Type answer here...">{{old('answer')}}</textarea>
                                                @error('answer')
                                                <i class="text-danger mt-2">{{$message}}</i>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 d-flex justify-content-center">
                                            <div class="btn-group">
                                                ...
                                                <button type="submit" class="btn btn-mini btn-primary">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
